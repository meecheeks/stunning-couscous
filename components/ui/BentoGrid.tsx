  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(311deg, rgba(0,0,0,1) 0%, rgba(20,20,20,1) 44%, rgba(17,15,10,1) 100%)',
      }}
    >
      <div className={`${ id === 6 } && 'flex justify-center h-full`}>
        ...
        <div>
          {id === 6 && (
            <BackgroundGradientAnimation>
              <div className="absolute z-50 flex itmes-center justify-center text-white font-bold">
              </div>
            </BackgroundGradientAnimation>
          )}
        </div>
        <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10'
            ...
            <div className="className=font-sans font-extralight text-[#c1c2d3] text-sm md:text-xs lg:text-base z-10">
              {description}
            </div>
        ...
        {id === 3 && (
          <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
            <div className="flex flex-col gap-3 lg:gap-8">
              {['Prototyping', 'Wireframing', 'A/B Testing'].map
              ((item) => (
            ...
            <div className="flex flex-col gap-3 lg:gap-8">
              {['Figma', 'Design Systems', 'HTML', 'CSS'].map
              ((item) => (
                <span key={item} className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E}">
                  {item}
                </span>
